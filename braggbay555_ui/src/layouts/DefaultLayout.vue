...
-->>
				...
				<a-menu-item>
					<router-link to="/productCategorys">
						<span class="label">Product Categorys</span>
					</router-link>
				</a-menu-item>
				...
				<a-menu-item>
					<router-link to="/shippings">
						<span class="label">Shippings</span>
					</router-link>
				</a-menu-item>
