...
<template>
  ...
  <base-input label="NotificationDate" type="text" placeholder="Enter NotificationDate" v-model="notificationToAdd.notificationDate"></base-input>
                  </form>
                </div>
    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'notificationDate',
          visible: true,
          scopedSlots: { customRender: 'notificationDate' },
          sorter: true
          //sorter: (a, b) => a.notificationDate - b.notificationDate,
