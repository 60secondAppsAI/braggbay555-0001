...
<template>
  ...
  <base-input label="LoyaltyPoints" type="text" placeholder="Enter LoyaltyPoints" v-model="buyerToAdd.loyaltyPoints"></base-input>
                  </form>
                </div>
    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'loyaltyPoints',
          visible: true,
          scopedSlots: { customRender: 'loyaltyPoints' },
          sorter: true
          //sorter: (a, b) => a.loyaltyPoints - b.loyaltyPoints,
          //sorter: (a, b) => a.loyaltyPoints.localeCompare(b.loyaltyPoints),
        },
      ],
      pagination: {
        current: 1,
